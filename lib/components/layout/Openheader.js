...
import { openRoutes } from "@/lib/helperFunctions/constants";
...
const OpenHeader = () => {
  ...
  const [navigation, setNavigation] = useState([...openRoutes]);
  const [userNavigation, setUserNavigation] = useState([
    { name: "Sign In", onClick: handleLogin },
  ]);
                        ...
                        <Link key={item.name} href={item.path}>
                          <div
                            className={classNames(
                              ...
                              "rounded-md px-3 py-2 text-sm font-medium mr-2 flex items-center"
                            )}
